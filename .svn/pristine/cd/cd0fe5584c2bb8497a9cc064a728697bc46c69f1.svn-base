...
-(NSData*)SubmitFeedback:(NSString*)isLike content:(NSString*)msg email:(NSString*)addr
{
    NSDictionary* params = [NSDictionary dictionaryWithObjectsAndKeys:@"lightmeter.ruhe.com", @"app",
                            isLike, @"s",
                            addr, @"u",
                            msg, @"a",
                            nil];
